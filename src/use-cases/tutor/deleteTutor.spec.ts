...
import { DeleteTutorUseCase } from "./deleteTutor";
...
let deleteTutorTest: DeleteTutorUseCase
...
describe('testing the create tutors use case', () => {
    beforeEach(() => {
        ...
        deleteTutorTest = new DeleteTutorUseCase(tutorRepository, animalRepository)
